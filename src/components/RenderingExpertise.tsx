  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "1.25rem", maxWidth: "800px", margin: "1rem auto" }}>
        At <strong>fr<span style={{ color: "var(--primary-color)"}}>ii</span>z</strong>, we specialize in cutting-edge <strong>3D rendering</strong> solutions. Our team is dedicated to
        delivering high-quality visualizations, enabling seamless integration of 3D assets into your projects. Whether it's for
        scientific visualization, creative rendering, or radiance fields, we bring your ideas to life with precision and innovation.
      </p>
    </section>
  );
};
